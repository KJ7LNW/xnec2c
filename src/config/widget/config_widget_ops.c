...
static void config_widget_reach_members(const config_widget_operation_t *op,
    const config_widget_group_view_t *gv, const void *operand);
static void config_widget_target_visible(const config_widget_target_t *t,
    const void *operand);
static void config_widget_target_sensitive(const config_widget_target_t *t,
    const void *operand);
static void config_widget_target_tooltip(const config_widget_target_t *t,
    const void *operand);
static void config_widget_target_connect(const config_widget_target_t *t,
    const void *operand);
static void config_widget_target_flush(const config_widget_target_t *t,
    const void *operand);
static void config_widget_target_capture(const config_widget_target_t *t,
    const void *operand);
